...
- [2. CSS Comments](#2-css-comments)
- [3. variables](#3-variables)
- [4. Text Formatting](#4-text-formatting)
    - [4.0.1. text-color](#401-text-color)
    - [4.0.2. text-alignment](#402-text-alignment)
    - [4.0.3. text-direction:](#403-text-direction)
    - [4.0.4. text-decoration:](#404-text-decoration)
    - [4.0.5. Text-transformation:](#405-text-transformation)
    - [4.0.6. letter-spacing:](#406-letter-spacing)
    - [4.0.7. word-spacing:](#407-word-spacing)
    - [4.0.8. line-height:](#408-line-height)
    - [4.0.9. text-shadow:](#409-text-shadow)
    - [4.0.10. font-size:](#4010-font-size)
    - [4.0.11. font-weight:](#4011-font-weight)
- [5. Margin](#5-margin)
    - [5.0.1. margin: auto;](#501-margin-auto)
    - [5.0.2. Margin Collapse](#502-margin-collapse)
- [6. Border](#6-border)
- [7. Padding](#7-padding)
- [8. Box-Modal](#8-box-modal)
    - [8.0.1. box-sizing: border-box](#801-box-sizing-border-box)
- [9. Background Properties](#9-background-properties)
- [10. Units](#10-units)
- [11. Selectors](#11-selectors)
    - [11.0.1. Simple Selectors](#1101-simple-selectors)
      - [11.0.1.1. Element Selector](#11011-element-selector)
      - [11.0.1.2. Id Selector](#11012-id-selector)
      - [11.0.1.3. Class Selector](#11013-class-selector)
      - [11.0.1.4. Universal Selector](#11014-universal-selector)
      - [11.0.1.5. Groping Selector](#11015-groping-selector)
    - [11.0.2. Combinator Selectors](#1102-combinator-selectors)
      - [11.0.2.1. Descendant Combinator](#11021-descendant-combinator)
      - [11.0.2.2. Child Combinator](#11022-child-combinator)
    - [11.0.3. Pseudo-class Selectors](#1103-pseudo-class-selectors)
      - [11.0.3.1. :link, :visited, :hover, :active](#11031-link-visited-hover-active)
      - [11.0.3.2. :hover](#11032-hover)
      - [11.0.3.3. input:focus](#11033-inputfocus)
      - [11.0.3.4. :nth-child()](#11034-nth-child)
    - [11.0.4. Pseudo-elements selectors](#1104-pseudo-elements-selectors)
      - [11.0.4.1. ::before, ::after, ::first-letter, ::first-line](#11041-before-after-first-letter-first-line)
    - [11.0.5. Attribute selectors](#1105-attribute-selectors)
      - [11.0.5.1. `[type="text"]`, `[target="_blank"]`](#11051-typetext-target_blank)
      - [11.0.5.2. `[class^="btn-"]`](#11052-classbtn-)
- [12. Table](#12-table)
- [13. Display Property](#13-display-property)
- [14. Position Property](#14-position-property)
    - [14.0.1. static(default):](#1401-staticdefault)
    - [14.0.2. Relative:](#1402-relative)
    - [14.0.3. absolute:](#1403-absolute)
    - [14.0.4. Sticky:](#1404-sticky)
    - [14.0.5. Fixed:](#1405-fixed)
    - [14.0.6. When to use relative and absolute?](#1406-when-to-use-relative-and-absolute)
...
- [19. Media Queries](#19-media-queries)
    - [19.0.1. Media Type:](#1901-media-type)
    - [19.0.2. Media features](#1902-media-features)
    - [19.0.3. Common breakpoints](#1903-common-breakpoints)
- [20. flex](#20-flex)
    - [20.0.1. Container Properties:](#2001-container-properties)
      - [20.0.1.1. justify-content](#20011-justify-content)
      - [20.0.1.2. align-items](#20012-align-items)
      - [20.0.1.3. align-content](#20013-align-content)
      - [20.0.1.4. flex-warp](#20014-flex-warp)
      - [20.0.1.5. flex-direction](#20015-flex-direction)
      - [20.0.1.6. flex-flow](#20016-flex-flow)
    - [20.0.2. Items Properties:](#2002-items-properties)
      - [20.0.2.1. order](#20021-order)
      - [20.0.2.2. flex-grow](#20022-flex-grow)
      - [20.0.2.3. flex-shrink](#20023-flex-shrink)
      - [20.0.2.4. flex-basis](#20024-flex-basis)
      - [20.0.2.5. flex](#20025-flex)
        - [20.0.2.5.1. flex:1;](#200251-flex1)
      - [20.0.2.6. align-self](#20026-align-self)
    - [20.0.3. Example:](#2003-example)
      - [20.0.3.1. Perfect Centering with justify-content and align-items](#20031-perfect-centering-with-justify-content-and-align-items)
      - [20.0.3.2. Perfect Centering with margin: auto;](#20032-perfect-centering-with-margin-auto)
- [21. Grid](#21-grid)
    - [21.0.1. Grid Container](#2101-grid-container)
    - [21.0.2. grid-template-columns](#2102-grid-template-columns)
    - [21.0.3. grid-template-rows](#2103-grid-template-rows)
    - [21.0.4. justify-content](#2104-justify-content)
      - [21.0.4.1. justify-content: space-evenly:](#21041-justify-content-space-evenly)
      - [21.0.4.2. justify-content: space-around;](#21042-justify-content-space-around)
      - [21.0.4.3. justify-content: space-between;](#21043-justify-content-space-between)
      - [21.0.4.4. justify-content: center;](#21044-justify-content-center)
      - [21.0.4.5. justify-content: start (default);](#21045-justify-content-start-default)
      - [21.0.4.6. justify-content: end;](#21046-justify-content-end)
    - [21.0.5. align-content](#2105-align-content)
      - [21.0.5.1. align-content: space-evenly:](#21051-align-content-space-evenly)
      - [21.0.5.2. align-content: space-around;](#21052-align-content-space-around)
      - [21.0.5.3. align-content: space-between;](#21053-align-content-space-between)
      - [21.0.5.4. align-content: center;](#21054-align-content-center)
      - [21.0.5.5. align-content: start;](#21055-align-content-start)
      - [21.0.5.6. align-content: end;](#21056-align-content-end)
      - [21.0.5.7. align-content: stretch (default)](#21057-align-content-stretch-default)
    - [21.0.6. place-content](#2106-place-content)
    - [21.0.7. Grid Items](#2107-grid-items)
    - [21.0.8. grid-column-start, grid-column-end and grid-column](#2108-grid-column-start-grid-column-end-and-grid-column)
    - [21.0.9. grid-row-start, grid-row-end, grid-row](#2109-grid-row-start-grid-row-end-grid-row)
    - [21.0.10. grid-area](#21010-grid-area)
    - [21.0.11. justify-self, align-self, place-self](#21011-justify-self-align-self-place-self)
      - [21.0.11.1. justify-self](#210111-justify-self)
      - [21.0.11.2. align-self](#210112-align-self)
      - [21.0.11.3. place-self](#210113-place-self)
    - [21.0.12. Grid Tricks:](#21012-grid-tricks)
      - [21.0.12.1. repeat() function](#210121-repeat-function)
      - [21.0.12.2. Difference between 1fr and auto](#210122-difference-between-1fr-and-auto)
      - [21.0.12.3. Difference between auto-fill, auto-fit and 1fr:](#210123-difference-between-auto-fill-auto-fit-and-1fr)
      - [21.0.12.4. grid-template-areas and grid area:](#210124-grid-template-areas-and-grid-area)
      - [21.0.12.5. Simple Layout using grid:](#210125-simple-layout-using-grid)
      - [21.0.12.6. Example-1:](#210126-example-1)
      - [21.0.12.7. Example-2:](#210127-example-2)
      - [21.0.12.8. Example-3:](#210128-example-3)
- [22. Transition](#22-transition)
    - [22.0.1. transition-timing-function](#2201-transition-timing-function)
- [23. Transform](#23-transform)
    - [23.0.1. translate(x-axis, y-axis)](#2301-translatex-axis-y-axis)
    - [23.0.2. rotate()](#2302-rotate)
    - [23.0.3. scale()](#2303-scale)
    - [23.0.4. skew(x-axis, y-axis)](#2304-skewx-axis-y-axis)
    - [23.0.5. matrix()](#2305-matrix)
    - [23.0.6. rotateX(), rotateY() and rotateZ()](#2306-rotatex-rotatey-and-rotatez)
...
### 11.0.1. Simple Selectors
#### 11.0.1.1. Element Selector
...
#### 11.0.2.1. Descendant Combinator
...
### 11.0.3. Pseudo-class Selectors
A pseudo-class is used to define a special state of an element. 
#### 11.0.3.1. :link, :visited, :hover, :active
...
### 11.0.4. Pseudo-elements selectors
#### 11.0.4.1. ::before, ::after, ::first-letter, ::first-line
...
### 11.0.5. Attribute selectors

#### 11.0.5.1. `[type="text"]`, `[target="_blank"]`
...
```
### 14.0.6. When to use relative and absolute?
...
### 20.0.1. Container Properties: 

#### 20.0.1.1. justify-content
...
### 20.0.3. Example:
#### 20.0.3.1. Perfect Centering with justify-content and align-items
...
#### 20.0.3.2. Perfect Centering with margin: auto;
...
### 21.0.1. Grid Container

### 21.0.2. grid-template-columns
...
### 21.0.8. grid-column-start, grid-column-end and grid-column
...
### 21.0.9. grid-row-start, grid-row-end, grid-row
...
### 21.0.11. justify-self, align-self, place-self
#### 21.0.11.1. justify-self
...
#### 21.0.12.2. Difference between 1fr and auto
...
#### 21.0.12.3. Difference between auto-fill, auto-fit and 1fr:
...
#### 21.0.12.4. grid-template-areas and grid area:
...
#### 21.0.12.5. Simple Layout using grid:
...
### 22.0.1. transition-timing-function
...
# 23. Transform
### 23.0.1. translate(x-axis, y-axis)
...
### 23.0.6. rotateX(), rotateY() and rotateZ()
